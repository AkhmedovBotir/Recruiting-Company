/**
 * Delete Vacancy Modal Component
 */

import { motion, AnimatePresence } from 'framer-motion';

const DeleteVacancyModal = ({ isOpen, onClose, onDelete, vacancy, loading }) => {
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-white px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Vakansiyani O'chirish</h3>
                <button
                  onClick={onClose}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-500">
                    Siz rostdan ham <span className="font-semibold text-gray-900">"{vacancy.title}"</span> vakansiyasini o'chirmoqchimisiz?
                  </p>
