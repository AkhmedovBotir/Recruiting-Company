...
const CreateVacancyModal = ({ isOpen, onClose, onCreate, selectedCompanyId }) => {
  ...
  // Load companies and set default
  useEffect(() => {
    if (isOpen) {
      loadCompanies();
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-white px-6 py-4 flex-shrink-0">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Yangi Vakansiya Qo'shish</h3>
                <button
                  onClick={handleClose}
              ...
              <div className="bg-white px-6 py-4 space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled={loadingCompanies || !!selectedCompanyId}
                    className={`w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.company ? 'border-red-300' : 'border-gray-300'
                    } ${loadingCompanies || selectedCompanyId ? 'bg-gray-100 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                  ...
                  {selectedCompanyId && (
                    <p className="mt-1 text-xs text-gray-500">Kompaniya sidebar dan tanlangan</p>
                  )}
                </div>
