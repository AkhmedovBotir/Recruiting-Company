...
const EditCompanyModal = ({ isOpen, onClose, onUpdate, company }) => {
  ...
  const formatPhoneNumber = (value) => {
    // Remove +998 prefix and all non-digit characters
    const cleaned = value.replace(/\+998/g, '').replace(/\D/g, '');
  ...
  useEffect(() => {
    if (company) {
      setFormData({
        ...
        ownerPhone: formatPhoneNumber(company.ownerPhone || ''),
        companyPhone: formatPhoneNumber(company.companyPhone || ''),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await onUpdate(company._id, submitData);
      handleClose();
    } catch (error) {
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-white px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Kompaniya Ma'lumotlarini Tahrirlash</h3>
                <button
                  onClick={handleClose}
            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-white px-6 py-4">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  {/* INN */}
                  <div>
                    <label htmlFor="edit-inn" className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  {/* Owner Full Name */}
                  <div>
                    <label htmlFor="edit-ownerFullName" className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  {/* Owner Phone */}
                  <div>
                    <label htmlFor="edit-ownerPhone" className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  {/* Company Phone */}
                  <div>
                    <label htmlFor="edit-companyPhone" className="block text-sm font-medium text-gray-700 mb-2">
