...
const DeleteCompanyModal = ({ isOpen, onClose, onDelete, company, loading }) => {
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-white px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Kompaniyani O'chirish</h3>
                <button
                  onClick={onClose}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-500">
                    Siz rostdan ham <span className="font-semibold text-gray-900">"{company.name}"</span> kompaniyasini o'chirmoqchimisiz?
                  </p>
