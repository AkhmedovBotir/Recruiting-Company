...
const EditMaterialModal = ({ isOpen, onClose, onUpdate, material }) => {
  ...
  // Populate form when material data is available
  useEffect(() => {
    if (material) {
      setFormData({
        ...
        tests: material.tests ? JSON.parse(JSON.stringify(material.tests)) : [],
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await onUpdate(material._id, submitData);
      handleClose();
    } catch (error) {
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-white px-6 py-4 flex-shrink-0">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Materialni Tahrirlash</h3>
                <button
                  onClick={handleClose}
