...
const RevokeCertificateModal = ({ isOpen, onClose, onRevoke, certificate, loading }) => {
          ...
          >
            ...
            <div className="border-b border-gray-200 bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white">Sertifikatni Bekor Qilish</h3>
                <button
                  onClick={onClose}
            ...
            <div className="bg-white px-6 py-6">
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    Sertifikatni bekor qilishni tasdiqlaysizmi?
                  </h4>
                  <p className="text-sm text-gray-600">
                    Bu amalni qaytarib bo'lmaydi. Sertifikat statusi "Bekor qilingan" ga o'zgaradi va QR kod orqali tekshirilmaydi.
                  </p>
                </div>
                ...
                {certificate.candidate && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Sertifikat: {certificate.certificateNumber}</p>
                  </div>
                )}
              </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  type="button"
                  onClick={() => onRevoke(certificate._id || certificate.id)}
                  disabled={loading}
